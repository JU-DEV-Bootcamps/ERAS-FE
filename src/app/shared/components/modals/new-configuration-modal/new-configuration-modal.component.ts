...
import { forbiddenCharsValidator } from '@core/utils/validators/forbiden-chars.validator';
import { noWhitespaceValidator } from '@core/utils/validators/no-whitespace.validator';
import { duplicatePropertyValidator } from '@core/utils/validators/duplicateProperty.validator';
...
@Component({
  ...
  styleUrl: './new-configuration-modal.component.scss',
})
