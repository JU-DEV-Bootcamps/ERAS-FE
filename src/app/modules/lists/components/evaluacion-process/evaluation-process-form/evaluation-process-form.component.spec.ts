...
describe('EvaluationProcessFormComponent', () => {
  ...
  describe('getPollDetails', () => {
    it('should get poll names and truncate their names under 100 characters on success', () => {
      ...
      expect(component.pollsNames.length).toBe(2);
      expect(component.pollsNames[0].name).toBe(mockPollNames[0].name);
      expect(component.pollsNames[1].name.length).toBe(100);
    });
